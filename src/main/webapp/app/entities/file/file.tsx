...
import { getEntities, searchEntities } from './file.reducer';
  ...
  return (
    <div>
      <h2 id="file-heading" data-cy="FileHeading">
        <Translate contentKey="fileShareAppV1App.file.home.title">Files</Translate>
        <div className="d-flex justify-content-end">
          <Button className="me-2" color="info" onClick={handleSyncList} disabled={loading}>
            <FontAwesomeIcon icon="sync" spin={loading} />{' '}
            <Translate contentKey="fileShareAppV1App.file.home.refreshListLabel">Refresh List</Translate>
          </Button>
          <Link to="/file/new" className="btn btn-primary jh-create-entity" id="jh-create-entity" data-cy="entityCreateButton">
            <FontAwesomeIcon icon="plus" />
            &nbsp;
            <Translate contentKey="fileShareAppV1App.file.home.createLabel">Create new File</Translate>
          </Link>
        </div>
      </h2>
      <Row>
            ...
            <FormGroup>
              <InputGroup>
                <Input
                  ...
                  placeholder={translate('fileShareAppV1App.file.home.search')}
                />
        ...
        {fileList && fileList.length > 0 ? (
            ...
            <thead>
              <tr>
                <th className="hand" onClick={sort('id')}>
                  <Translate contentKey="fileShareAppV1App.file.id">ID</Translate> <FontAwesomeIcon icon={getSortIconByFieldName('id')} />
                </th>
                ...
                <th>
                  <Translate contentKey="fileShareAppV1App.file.post">Post</Translate> <FontAwesomeIcon icon="sort" />
                </th>
                <th />
              </tr>
            </thead>
            <tbody>
              {fileList.map((file, i) => (
                <tr key={`entity-${i}`} data-cy="entityTable">
                  ...
                  <td>{file.mimeType}</td>
                  <td>{file.fileSize}</td>
                  <td>{file.uploadedAt ? <TextFormat type="date" value={file.uploadedAt} format={APP_DATE_FORMAT} /> : null}</td>
                  <td>{file.post ? <Link to={`/post/${file.post.id}`}>{file.post.id}</Link> : ''}</td>
                  <td className="text-end">
                    <div className="btn-group flex-btn-group-container">
                      ...
                      <Button
                        onClick={() =>
                          (window.location.href = `/file/${file.id}/delete?page=${paginationState.activePage}&sort=${paginationState.sort},${paginationState.order}`)
                        }
                        color="danger"
                        size="sm"
          ...
          !loading && (
            <div className="alert alert-warning">
              <Translate contentKey="fileShareAppV1App.file.home.notFound">No Files found</Translate>
            </div>
          )
        )}
      </div>
