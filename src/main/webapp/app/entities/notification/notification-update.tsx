  ...
  return (
    <div>
      <Row className="justify-content-center">
        <Col md="8">
          <h2 id="fileShareAppV1App.notification.home.createOrEditLabel" data-cy="NotificationCreateUpdateHeading">
            <Translate contentKey="fileShareAppV1App.notification.home.createOrEditLabel">Create or edit a Notification</Translate>
          </h2>
        </Col>
      </Row>
      <Row className="justify-content-center">
        <Col md="8">
          {loading ? (
            ...
            <ValidatedForm defaultValues={defaultValues()} onSubmit={saveEntity}>
              ...
              <ValidatedField
                label={translate('fileShareAppV1App.notification.message')}
              ...
              />
              <ValidatedField
                label={translate('fileShareAppV1App.notification.isRead')}
              ...
              />
              <ValidatedField
                label={translate('fileShareAppV1App.notification.createdAt')}
              ...
              <ValidatedField
                ...
                name="user"
                data-cy="user"
                label={translate('fileShareAppV1App.notification.user')}
                type="select"
              >
                <option value="" key="0" />
                {users
