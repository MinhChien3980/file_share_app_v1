...
import static com.fileshareappv1.myapp.security.jwt.JwtAuthenticationTestUtils.*;
...
class TokenAuthenticationIT {
    ...
    @MockitoBean
    private com.fileshareappv1.myapp.service.FirebaseUserService firebaseUserService;
