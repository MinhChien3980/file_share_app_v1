...
import static com.fileshareappv1.myapp.domain.NotificationAsserts.*;
...
import com.fileshareappv1.myapp.service.NotificationService;
...
class NotificationResourceIT {
    ...
    public static Notification createEntity() {
        return new Notification().message(DEFAULT_MESSAGE).isRead(DEFAULT_IS_READ).createdAt(DEFAULT_CREATED_AT);
    }
    ...
    public static Notification createUpdatedEntity() {
        return new Notification().message(UPDATED_MESSAGE).isRead(UPDATED_IS_READ).createdAt(UPDATED_CREATED_AT);
    }
    ...
    void putExistingNotification() throws Exception {
        ...
        updatedNotification.message(UPDATED_MESSAGE).isRead(UPDATED_IS_READ).createdAt(UPDATED_CREATED_AT);
    ...
    void partialUpdateNotificationWithPatch() throws Exception {
        ...
        partialUpdatedNotification.message(UPDATED_MESSAGE).isRead(UPDATED_IS_READ);
    ...
    void fullUpdateNotificationWithPatch() throws Exception {
        ...
        partialUpdatedNotification.message(UPDATED_MESSAGE).isRead(UPDATED_IS_READ).createdAt(UPDATED_CREATED_AT);
